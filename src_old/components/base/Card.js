...
const Card = (props) => {
  ...
  return (
      <MDBCol md='3' style={{marginTop: '40px'}}>
        <MDBCard narrow style={{height: '530px'}}>
          <MDBView cascade className='card__view'>
            { props.obj.show_image ? (            
                ...
                <div class="card__image embed-responsive embed-responsive-16by9">
                   <iframe class="embed-responsive-item" src={props.obj.video} title={props.obj.title} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>            
            )}
          </MDBView>
